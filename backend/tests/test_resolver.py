...
from app.graph.nodes.n5_resolve import _select_golden_record, _normalise_phone, _normalise_domain
...
def test_normalise_domain() -> None:
    assert _normalise_domain("https://www.cult.fit/gyms/koramangala") == "cult.fit"
    assert _normalise_domain("http://goldsgym.in/index.html") == "goldsgym.in"
...
def test_golden_record_merge() -> None:
    ...
    golden = _select_golden_record([cand1, cand2])
